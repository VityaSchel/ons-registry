  ...
  try {
    ...
    if (content.language === 'ru') {
      ...
      if ('seedPhrase' in content) {
        ...
        text += `\n\nWhen making the purchase, you specified your own OXEN wallet, to which the nickname was linked: ${content.ownerOxen}. Remember that anyone having access to this OXEN wallet can rebind your nickname to another Session account, so do not share access to this wallet to anyone.`
      }
      ...
      text += '\n\nIf you have any questions, please contact us at Telegram: @hlothdev (preferrably) or by e-mail: onspurchase@hloth.dev or by Session nickname: hloth (slowest). This account is used to automatically send receipts, so please do not send messages to it — they won\'t be delivered and seen.'
